package com.vehicleApp.vehicleDealership;
...
import com.comp1011.assignment3.R;
import com.comp1011.vehicleDealership.model.Vehicle;
import com.google.android.material.card.MaterialCardView;
import com.google.android.material.textview.MaterialTextView;
import com.vehicleApp.vehicleDealership.controller.VehicleController;
...
public class ViewSoldVehicles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_sold_vehicles);

        // Get references to layout elements
        cardListLayout = findViewById(R.id.sold_card_list);
        ...
        try {
            VehicleController vehicleController = new VehicleController(ViewSoldVehicles.this);
            vehicleList = vehicleController.getSoldVehicles();
        } catch (IOException e) {
            throw new RuntimeException(e);
        } catch (ParseException e) {
            throw new RuntimeException(e);
        ...
        sortSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                try {
                    vehicleController = new VehicleController(ViewSoldVehicles.this);
                } catch (IOException e) {
                    throw new RuntimeException(e);
                } catch (ParseException e) {
                    throw new RuntimeException(e);
    ...
    private void addCardView(Vehicle vehicle) {
        ...
        cardViewLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ViewSoldVehicles.this, ViewSingleVehicle.class);
