...
public class ViewAvailableVehicles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get references to layout elements
        cardListLayout = findViewById(R.id.available_card_list);
        ...
        try {
            VehicleController vehicleController = new VehicleController(ViewAvailableVehicles.this);
            vehicleList = vehicleController.getAvailableVehicles();
        } catch (IOException e) {
            throw new RuntimeException(e);
        } catch (ParseException e) {
            throw new RuntimeException(e);
        ...
        sortSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                try {
                    vehicleController = new VehicleController(ViewAvailableVehicles.this);
                } catch (IOException e) {
                    throw new RuntimeException(e);
                } catch (ParseException e) {
                    throw new RuntimeException(e);
    ...
    private void addCardView(Vehicle vehicle) {
        ...
        cardViewLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ViewAvailableVehicles.this, ViewSingleVehicle.class);
